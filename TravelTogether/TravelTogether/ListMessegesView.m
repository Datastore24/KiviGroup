...
- (UIView*) setCustomCellWithView: (UIView*) view andImage: (NSString*) imageName
    ...
    if (isiPhone6) {
        labelName.frame = CGRectMake(95.f, 26.25f, 10.f, 20.f);
    ...
    if (isiPhone6) {
        labelAge.frame = CGRectMake(95.f + labelName.frame.size.width + 3.f, 26.25f, 10.f, 20.f);
    ...
    if (isiPhone6) {
        labelMessegeText.frame = CGRectMake(95.f, 39.f, 147.5f, 12.f);
        labelMessegeText.font = [UIFont fontWithName:VM_FONT_BEAU_SANS_REGULAR size:12];
    }
    ...
    if (isiPhone6) {
        labelDate.frame = CGRectMake(95.f, 54.f, 147.5f, 12.f);
        labelDate.font = [UIFont fontWithName:VM_FONT_BEAU_SANS_REGULAR size:9];
        [labelDate sizeToFit];
    }
