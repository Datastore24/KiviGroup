                     ...
                     andData: (NSArray*) data
{
    ...
    if (self) {
        ...
        textLabel.attributedText = [self atributeWithString:@"Минимальная сумма заказа 990 рублей.\nСбор заказа начинается после 100% предоплаты и длится от 1 до 7 рабочих дней, отправки заказов происходят каждый день.\nПри самовывозе предоплата так же 100%!\nПосле оплаты заказа для более скорейшего начала сборки сообщайте ответным письмом на счет к заказу что Вы оплатили и с какого счета." andBoldText:@"990 рублей" andBoldTwo: @"от 1 до 7 рабочих дней"];
