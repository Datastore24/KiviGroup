...
- (instancetype)initWithView: (UIView*) view andArray: (NSMutableArray*) array
{
    ...
    if (self) {
        ...
        mainScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 232, self.frame.size.width, self.frame.size.height - 232)];
...
- (void) cameraButtonAction
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_REQUEST_IMAGE_FOR_CHAT object:nil];
}
