...
- (void)viewDidLoad {
    ...
    UILabel * CustomText = [[UILabel alloc]initWithTitle:@"Просмотр"];
...
- (void)prepareNavigationBar {
    ...
    UIBarButtonItem *cancelItem = [[UIBarButtonItem alloc] initWithTitle:@"Назад" style:UIBarButtonItemStylePlain target:self action:@selector(backToController)];
