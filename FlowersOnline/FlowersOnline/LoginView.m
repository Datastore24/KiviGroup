...
#pragma mark - REGISTRATION
        ...
        //Создание кнопки----------------
        UIButton * buttonNext = [ButtonMenu createButtonRegistrationWithName:@"Продолжить" andColor:@"000000" andPointY:612 andView:self];
        if (isiPhone6) {
        ...
        //Содание кнопки регистрация------
        UIButton * buttonLicAgreement =[ButtonMenu createButtonTextWithName:@"Лицензионное соглашение" andFrame:CGRectMake(20, 695, self.frame.size.width - 40, 20) fontName:FONTLITE];
        if (isiPhone6) {
